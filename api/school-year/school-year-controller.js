...
async function getSchoolYears(req, res, next) {
  try {
    const schoolYears = await schoolYearService.getSchoolYears({ context: req.context })
...
async function getSchoolYearById(req, res, next) {
  try {
    ...
    const schoolYear = await schoolYearService.getSchoolYearById(id, { context: req.context })
    res.json(schoolYear)
  } catch (err) {
...
async function getCurrentSchoolYear(req, res, next) {
  try {
    const schoolYear = await schoolYearService.getCurrentSchoolYear({ context: req.context })
    res.json(schoolYear)
  } catch (err) {
...
async function createSchoolYear(req, res, next) {
  try {
    ...
    const newSchoolYear = await schoolYearService.createSchoolYear(schoolYearData, { context: req.context })
...
async function updateSchoolYear(req, res, next) {
  try {
    ...
    const updatedSchoolYear = await schoolYearService.updateSchoolYear(id, schoolYearData, { context: req.context })
...
async function setCurrentSchoolYear(req, res, next) {
  try {
    ...
    const schoolYear = await schoolYearService.setCurrentSchoolYear(id, { context: req.context })
    res.json(schoolYear)
  } catch (err) {
...
async function rolloverToNewYear(req, res, next) {
  try {
    ...
    const newSchoolYear = await schoolYearService.rolloverToNewYear(id, { context: req.context })
