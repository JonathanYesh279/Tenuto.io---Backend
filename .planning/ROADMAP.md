...
Plans:
- [x] 03-01-PLAN.md -- stripTenantId middleware + Joi schema defense-in-depth (all validation files)
...
Plans:
- [x] 04-01-PLAN.md -- Create CROSS_TENANT_ALLOWLIST constant, tenant-scope admin routes, fix past-activities context threading
- [x] 04-02-PLAN.md -- Allowlist validation utility and architecture docs update
...
Plans:
- [x] 09-01-PLAN.md -- Fix column detection logic (dynamic instrument threshold, sub-header guard, boolean disambiguation, header variants, diagnostic report)
